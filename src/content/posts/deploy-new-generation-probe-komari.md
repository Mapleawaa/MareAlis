...
![image-20250807182338833](./deploy-new-generation-probe-komari-img/image-20250807182338833.png)

配置好**Acme账户**和**DNS账户**，此处ACME账户更推荐创建ZeroSSL，原因见:[为什么选择ZeroSSL](https://ffis.me/archives/2110.html)![image-20250807182440568](./deploy-new-generation-probe-komari-img/image-20250807182440568.png)

### 2. 创建反向代理

前往**网站**选项卡，点击创建网站，在弹出界面的上部选择反向代理，并填写好需要监听的域名

![image-20250807182709011](./deploy-new-generation-probe-komari-img/image-20250807182709011.png)

此处选择**启用HTTPS**，并且勾选我们已经创建好的证书。

![image-20250807182853695](./deploy-new-generation-probe-komari-img/image-20250807182853695.png)
...
![image-20250807183125445](./deploy-new-generation-probe-komari-img/image-20250807183125445.png)

### 2. SSL/TLS配置

> SSL/TLS >> 概述

![image-20250807183649257](./deploy-new-generation-probe-komari-img/image-20250807183649257.png)
...
![image-20250807183741307](./deploy-new-generation-probe-komari-img/image-20250807183741307.png)

> 速度 >> 优化 >> 协议优化

![image-20250807184017896](./deploy-new-generation-probe-komari-img/image-20250807184017896.png)
...
![image-20250807184254701](./deploy-new-generation-probe-komari-img/image-20250807184254701.png)
...
![image-20250807184600361](./deploy-new-generation-probe-komari-img/image-20250807184600361.png)

添加节点之后在你的节点列表中出现了一个刚才创建的节点。

点击铅笔图标进入编辑，你可以在此处修改详细的信息

![image-20250807184850807](./deploy-new-generation-probe-komari-img/image-20250807184850807.png)

随后点击钱币图标进入费用编辑，顾名思义，填写小鸡的价格、续费信息等

![image-20250807185029932](./deploy-new-generation-probe-komari-img/image-20250807185029932.png)
...
![image-20250807185224983](./deploy-new-generation-probe-komari-img/image-20250807185224983.png)
...
![image-20250807185453852](./deploy-new-generation-probe-komari-img/image-20250807185453852.png)

此时回到你的面板端，刷新一下即可在你的节点列表中找到你的服务器。

![image-20250807185620258](./deploy-new-generation-probe-komari-img/image-20250807185620258.png)
